def translate_ONP_to_ordinary(phrase):
    ...
    while len(phrase) > 0:
        ...
        if phrase[0] == "*":
            ...
            temp_queue[lenght_queue - 2] = int(temp_queue[lenght_queue - 1]) * int(
                temp_queue[lenght_queue - 2]
            )
        ...
        # if on index 0 at list "phrase" will be "/", program will see it as divided operator
            ...
            temp_queue[lenght_queue - 2] = int(temp_queue[lenght_queue - 2]) / int(
                temp_queue[lenght_queue - 1]
            )
